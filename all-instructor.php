...
<!-- Mirrored from template.codexshaper.com/admin/lms-hub/all-instructor.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2024 13:48:29 GMT -->
<head>
  <meta charset="utf-8">
                ...
                <div class="relative">
                    ...
                    <div id="dropdownProfile" class="invisible z-backdrop bg-white text-left divide-y divide-gray-100 rounded-lg shadow w-48 dark:bg-dark-card-shade dark:divide-dark-border-four dk-theme-card-square">
                        <div class="px-4 py-3 text-sm text-gray-500 dark:text-white">
                            ...
                            <div class="truncate"><a href="https://template.codexshaper.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1f7e737a672d2b2d2a5f78727e7673317c7072">[email&#160;protected]</a></div>
                        </div>
    ...
    <div class="main-content group-data-[sidebar-size=lg]:xl:ml-[calc(theme('spacing.app-menu')_+_16px)] group-data-[sidebar-size=sm]:xl:ml-[calc(theme('spacing.app-menu-sm')_+_16px)] px-4 group-data-[theme-width=box]:xl:px-0 ac-transition">
        <div class="card p-0 lg:min-h-[calc(100vh_-_theme('spacing.header')_*_1.4)] xl:min-h-[calc(100vh_-_theme('spacing.header')_*_1.6)]">
            <div class="flex flex-col gap-2 sm:flex-center-between sm:flex-row px-4 py-5 sm:p-7 bg-gray-200/30 dark:bg-dark-card-shade">
                <div>
                    <h6 class="card-title">Instructor list</h6>
                    <p class="card-description">All Instructor Here</p>
                </div>
                <a href="create-instructor.html" class="btn b-solid btn-primary-solid">Add Instructor</a>
            </div>
                    ...
                    <table class="table-auto border-collapse w-full whitespace-nowrap text-left text-gray-500 dark:text-dark-text font-medium">
                        <thead>
                            <tr class="text-primary-500">
                                ...
                                <th class="px-4 py-4 bg-[#F2F4F9] dark:bg-dark-card-two first:rounded-l-lg last:rounded-r-lg dk-theme-card-square">Total Course</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-dark-border">
                            <tr> 
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-3.5">
                                        <a href="#" class="size-12 rounded-50 overflow-hidden dk-theme-card-square">
                                            <img src="assets/images/student/student-2.png" alt="instructor">
                                        </a>
                                        <div>
                                ...
                                <td class="px-4 py-4"><a href="https://template.codexshaper.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bfdad3daded1d0cdffd8d2ded6d391dcd0d2">[email&#160;protected]</a></td>
                                <td class="px-4 py-4">9658242545</td>
                                <td class="px-4 py-4">South America</td>
                                <td class="px-4 py-4">5 - Course</td>
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="create-instructor.html" class="btn-icon btn-primary-icon-light size-7">
                                            <i class="ri-edit-2-line text-inherit text-[13px]"></i>
                                        </a>
                                        <a href="#" class="btn-icon btn-danger-icon-light size-7" data-modal-target="deleteModal" data-modal-toggle="deleteModal">
                            ...
                            <tr> 
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-3.5">
                                        <a href="#" class="size-12 rounded-50 overflow-hidden dk-theme-card-square">
                                            <img src="assets/images/student/student-1.png" alt="instructor">
                                        </a>
                                        <div>
                                            <h6 class="leading-none text-heading font-semibold">
                                ...
                                <td class="px-4 py-4"><a href="https://template.codexshaper.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3d55524a5c4f597d5a505c5451135e5250">[email&#160;protected]</a></td>
                                <td class="px-4 py-4">2145872545</td>
                                <td class="px-4 py-4">Canada</td>
                                <td class="px-4 py-4">8 - Course</td>
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="create-instructor.html" class="btn-icon btn-primary-icon-light size-7">
                                            <i class="ri-edit-2-line text-inherit text-[13px]"></i>
                            ...
                            <tr> 
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-3.5">
                                        <a href="#" class="size-12 rounded-50 overflow-hidden dk-theme-card-square">
                                            <img src="assets/images/student/student-3.png" alt="instructor">
                                        </a>
                                        <div>
                                            <h6 class="leading-none text-heading font-semibold">
                                ...
                                <td class="px-4 py-4"><a href="https://template.codexshaper.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5f3e333d3a2d2b1f38323e3633713c3032">[email&#160;protected]</a></td>
                                <td class="px-4 py-4">214584056</td>
                                <td class="px-4 py-4">Swizerland</td>
                                <td class="px-4 py-4">1 - Course</td>
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="create-instructor.html" class="btn-icon btn-primary-icon-light size-7">
                                            <i class="ri-edit-2-line text-inherit text-[13px]"></i>
                            ...
                            <tr> 
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-3.5">
                                        <a href="#" class="size-12 rounded-50 overflow-hidden dk-theme-card-square">
                                            <img src="assets/images/student/student-4.png" alt="instructor">
                                        </a>
                                        <div>
                                            <h6 class="leading-none text-heading font-semibold">
                                                <a href="#">Darlena Robertson</a>
                                            </h6>
                                            <p class="font-spline_sans text-sm font-light mt-1">Frontend Developer</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-4"><a href="https://template.codexshaper.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="167277647a73787756717b777f7a3875797b">[email&#160;protected]</a></td>
                                <td class="px-4 py-4">4214587935</td>
                                <td class="px-4 py-4">Japhan</td>
                                <td class="px-4 py-4">10 - Course</td>
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="create-instructor.html" class="btn-icon btn-primary-icon-light size-7">
                                            <i class="ri-edit-2-line text-inherit text-[13px]"></i>
                            ...
                            <tr> 
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-3.5">
                                        <a href="#" class="size-12 rounded-50 overflow-hidden dk-theme-card-square">
                                            <img src="assets/images/student/student-5.png" alt="instructor">
                                        </a>
                                        <div>
                                            <h6 class="leading-none text-heading font-semibold">
                                                <a href="#">Devon Lane</a>
                                ...
                                <td class="px-4 py-4"><a href="https://template.codexshaper.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="84e0e1f2ebeac4e3e9e5ede8aae7ebe9">[email&#160;protected]</a></td>
                                <td class="px-4 py-4">9658242545</td>
                                <td class="px-4 py-4">Australia</td>
                                <td class="px-4 py-4">15 - Course</td>
                                <td class="px-4 py-4">
                                    <div class="flex items-center gap-2">
                                        <a href="create-instructor.html" class="btn-icon btn-primary-icon-light size-7">
                                            <i class="ri-edit-2-line text-inherit text-[13px]"></i>
...
<!-- Mirrored from template.codexshaper.com/admin/lms-hub/all-instructor.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2024 13:48:34 GMT -->
</html>