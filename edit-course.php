...
<!-- Mirrored from template.codexshaper.com/admin/lms-hub/edit-course.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2024 13:48:27 GMT -->
<head>
  <meta charset="utf-8">
                ...
                <div class="relative">
                    ...
                    <div id="dropdownProfile" class="invisible z-backdrop bg-white text-left divide-y divide-gray-100 rounded-lg shadow w-48 dark:bg-dark-card-shade dark:divide-dark-border-four dk-theme-card-square">
                        <div class="px-4 py-3 text-sm text-gray-500 dark:text-white">
                            ...
                            <div class="truncate"><a href="https://template.codexshaper.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="11707d74692325232451767c70787d3f727e7c">[email&#160;protected]</a></div>
                        </div>
    ...
    <div class="main-content group-data-[sidebar-size=lg]:xl:ml-[calc(theme('spacing.app-menu')_+_16px)] group-data-[sidebar-size=sm]:xl:ml-[calc(theme('spacing.app-menu-sm')_+_16px)] px-4 group-data-[theme-width=box]:xl:px-0 ac-transition">
        ...
        <div class="card p-4 lg:p-6">
            <div class="container relative">
                ...
                <div class="stepper-menu flex items-center text-center overflow-hidden divide-x divide-primary-300 scroll-smooth [&.dragging]:scroll-auto [&.dragging]:cursor-grab group/stepper-menu">
                    ...
                    <div class="card p-4 lg:p-6">
                        ...
                        <div class="grid grid-cols-2 gap-x-4 gap-y-5 mt-7 pt-0.5">
                            <div class="col-span-full lg:col-auto leading-none">
                                ...
                                <input type="text" id="courseTitle" placeholder="Course Title" value="Learn Advanced Web Development Build..." class="form-input" autocomplete="off" >
                            </div>
                            <div class="col-span-full lg:col-auto leading-none">
                                <label class="form-label">Courses category</label>
                                <select class="singleSelect" name="courseCategory">
                            ...
                            <div class="col-span-full lg:col-auto leading-none">
                                ...
                                <input type="text" id="organization" placeholder="Organization name" value="CodexShaper" class="form-input" autocomplete="off">
                            </div>
                            <div class="col-span-full lg:col-auto leading-none">
                                <label class="form-label">Instructor *</label>
                                <select class="multiSelect" name="instructor" multiple="multiple">
                                    <option>Example</option>
                                    <option value="val" selected>John Adams</option>
                            ...
                            <div class="col-span-full lg:col-auto leading-none">
                                ...
                                <select class="singleSelect" name="courseLabel" data-minimum-results-for-search="Infinity">
                                    <option disabled>Course Label</option>
                                    <option value="val">Beginner</option>
                                    <option value="val">Medium</option>
                                    <option value="val" selected>Advance</option>
                                </select>
                            </div>
                            <div class="col-span-full lg:col-auto leading-none">
                                ...
                                <select class="singleSelect" name="courseSubject">
                                    ...
                                    <option value="val">Basic Web Design</option>
                                    <option value="val" selected>Frontend Web Development</option>
                                    <option value="val">Javascript</option>
                                    <option value="val".html</option>
                                </select>
                            </div>
                            <div class="col-span-full lg:col-auto leading-none">
                                ...
                                <select class="singleSelect" name="courseSubject">
                                    ...
                                    <option value="val" selected>English</option>
                            ...
                            <div class="col-span-full lg:col-auto leading-none">
                                ...
                                <select class="singleSelect" name="timezone">
                                    <option disabled>Timezone</option>
                                    <option value="val" selected>USA</option>
                                    <option value="val">Africa</option>
                                    <option value="val">Canada</option>
                                </select>
                            </div>
                            <div class="col-span-full lg:col-auto leading-none">
                                <label for="courseDuration" class="form-label">Course duration *</label>
                                <input type="text" id="courseDuration" value="21:35:00" class="form-input" required>
                            ...
                            <div class="col-span-full">
                                ...
                                <textarea class="summernote">
                                    Programming courses cover a wide range of topics, from the basics of coding to advanced software development techniques. 
                                    These courses are designed to teach you how to write code in various programming languages, understand algorithms and data structures, 
                                    and develop applications and software solutions. Whether you're a beginner looking to learn the fundamentals or an experienced developer 
                                    seeking to enhance your skills, programming courses offer valuable knowledge and hands-on experience.
                                </textarea>
                                <div class="flex items-center gap-2 mt-3.5">
                                    <input type="checkbox" name="agreeTermCondition" id="agreeTermCondition" class="accent-primary-500">
                                    <label for="agreeTermCondition" class="text-xs form-label mb-0 select-none">I am totally agree with your term & condition</label>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from template.codexshaper.com/admin/lms-hub/edit-course.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2024 13:48:29 GMT -->
</html>