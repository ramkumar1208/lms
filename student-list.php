...
<!-- Mirrored from template.codexshaper.com/admin/lms-hub/component-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2024 13:48:48 GMT -->
                ...
                <div class="card p-0">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <table id="rowSelectionDeletion" class="group bordered">
                            <thead>
                                <tr>
                                    <th class="!bg-[#FEF6EC] dark:!bg-dark-card-shade">Course</th>
                                    <th class="!bg-[#FEF6EC] dark:!bg-dark-card-shade">Batch Code</th>
                                    <th class="!bg-[#FEF6EC] dark:!bg-dark-card-shade">Ic number</th>
                                    <th class="!bg-[#FEF6EC] dark:!bg-dark-card-shade">Name</th>
                                    <th class="!bg-[#FEF6EC] dark:!bg-dark-card-shade">Mobile</th>
                                    <th class="!bg-[#FEF6EC] dark:!bg-dark-card-shade">Date Of Birth</th>
...
<!-- Mirrored from template.codexshaper.com/admin/lms-hub/component-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Aug 2024 13:48:52 GMT -->
